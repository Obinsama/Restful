            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    <div class="form-group bmd-form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="name" required="true" aria-required="true">
                    </div>
                    <div class="form-group bmd-form-group">
                    ...
                    <div class="form-group bmd-form-group">
                        ...
                        <input type="password" class="form-control" name="confirm-password" id="passconfirm" required="true" aria-required="true">
                    </div>
