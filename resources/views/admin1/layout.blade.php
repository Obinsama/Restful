...
<head>
    ...
    <link href="{{asset('css/utopia-white.css')}}" rel="stylesheet">
    <link href="{{asset('css/utopia-responsive.css')}}" rel="stylesheet">
    <link href="{{asset('css/ui-lightness/jquery-ui.css')}}" rel="stylesheet" type="text/css">
    ...
    <link href="{{asset('css/chosen.css')}}" media="screen" rel="stylesheet" type="text/css"/>
        ...
        <div class="span12">
            ...
            <div class="header-top">
                ...
                <div class="header-wrapper">
                    ...
                    <a href="#" class="utopia-logo"><img src="img/utopia-logo.png" alt="Utopia"></a>
        ...
        <div class="span2 sidebar-container">
            ...
            <div class="sidebar">
                ...
                <div class="nav-collapse collapse leftmenu">
                    ...
                    <ul>
                        <li class="current"><a class="dashboard smronju" href="{{route('index')}}" title="Dashboard"><span>Dashboard</span></a></li>
{{--                        <li><a class="list" href="javascript:void(0)" title="Tables"><span>Tables</span></a>--}}
{{--                            <ul class="dropdown">--}}
{{--                                <li><a class="tables" href="tables.html" title="Tables"><span>Tables</span></a>--}}
{{--                                <li><a class="widgets smronju" href="pricingtables.html" title="Pricing Tables"><span>Pricingtables</span></a></li>--}}
{{--                            </ul>--}}
{{--                        </li>--}}
                        <li><a class="icon user" href="{{route('users.index')}}" title="Users"><span><i class="fa fa-user"></i>Users</span></a></li>
                        <li><a class="elements" href="{{route('roles.index')}}" title="Roles"><span>Roles</span></a></li>
